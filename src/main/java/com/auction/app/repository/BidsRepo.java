...
public interface BidsRepo extends JpaRepository<BidsEntity, Integer>{
	...
	@Query("SELECT u FROM BidsEntity u WHERE u.auctionId = :auctionId ORDER BY u.amount ASC, u.createdAt ASC")
	List<BidsEntity> findAllBidsByAuctionId(int auctionId);
}
